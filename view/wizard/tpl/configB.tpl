        ...
        <div class="sclogin-joomla-login">
            <form action="/index.php/countryfinale" method="post" id="sclogin-form">
                <div class="logout-button" id="scLogoutButton">
                    ...
                    <input type="hidden" name="3e0d34e6ff2d9a8d3b2b6d8a9bd83d4e" value="1" />                </div>
            </form>
        </div>
    </div>
