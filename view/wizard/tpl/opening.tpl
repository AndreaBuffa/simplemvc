...
var sp_offanimation = 'default';
	...
	<meta content="http://94.177.177.252/index.php/country-montagna" property="og:url" />
	<meta content="country montagna" property="og:title" />

                                </head>
                <body class="site com-sppagebuilder view-page no-layout no-task itemid-105 it-it ltr  layout-fluid off-canvas-menu-init">
				...
				<ul class="sp-megamenu-parent menu-fade hidden-sm hidden-xs"><li class="sp-menu-item"></li><li class="sp-menu-item"><a  href="/index.php/stili" >stili</a></li><li class="sp-menu-item"><a  href="/index.php/country-panorami" >country panorami</a></li><li class="sp-menu-item current-item active"><a  href="/index.php/country-montagna" >country montagna</a></li><li class="sp-menu-item"><a  href="/index.php/country-portafinestra-battente" >country portafinestra battente</a></li><li class="sp-menu-item"><a  href="/index.php/country-portafinestra-battente-esterno" >country portafinestra battente esterno</a></li><li class="sp-menu-item"><a  href="/index.php/countryfinale" >countryfinale</a></li><li class="sp-menu-item"><a  href="/index.php/pagina-utente-finale" >pagina utente finale</a></li><li class="sp-menu-item"><a  href="/index.php/moderno-panorami" >moderno panorami</a></li><li class="sp-menu-item"><a  href="/index.php/moderno-citta" >moderno citta</a></li><li class="sp-menu-item"><a  href="/index.php/moderno-portafinestra-scorrevole" >moderno portafinestra scorrevole</a></li><li class="sp-menu-item"><a  href="/index.php/moderno-portafinestra-scorrevole-esterno" >moderno portafinestra scorrevole esterno</a></li><li class="sp-menu-item"><a  href="/index.php/modernofinale" >modernofinale</a></li></ul>			</div>
...
<td style="width:1%; padding-right:8px;"></td>
    ...
    <div class="sclogout-button">
        <div class="sclogin-joomla-login">
            <form action="/index.php/country-montagna" method="post" id="sclogin-form">
...
<td style="width:4%">
<a href="#" style="padding: 0px 2px; font-size: 12px; line-height: 1px;" class="sppb-btn  sppb-btn-lg sppb-btn-square" title="">
<span class="rl_tooltips-link nn_tooltips-link hover top" data-toggle="popover" data-html="true" data-template="&lt;div class=&quot;popover rl_tooltips nn_tooltips &quot;&gt;&llt;div class=&quot;arrow&quot;&gt;&lt;/div&gt;&lt;div class=&quot;popover-inner&quot;&gt;&lt;h3 class=&quot;popover-title&quot;&gt;&lt;/h3&gt;&lt;div class=&quot;popover-content&quot;&gt;&lt;p&gt;&lt;/p&gt;&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;" data-placement="top" data-content="Condividi sui social la configurazione" title="Titolo Suggerimento">
<i class="fa fa-share-alt"></i></span>
</a>
</td>
<td style="width:1%"></td>
...
<i style="font-size:12px" class="fa fa-user"></i> Login</a></div></div></div></div></div></div></div></div></div><section id="section-id-1494080026687" class="sppb-section "  ><div class="sppb-row-container"><div class="sppb-row"><div class="sppb-col-md-6"><div id="column-id-1494080026688" class="sppb-column " ><div class="sppb-column-addons"><div id="sppb-addon-1494160813212" class="clearfix" ><div class="sppb-addon sppb-addon-module  marginib"><div class="sppb-addon-content">
  ...
  <script type="text/javascript">
    ...
    jQuery('#favimagehover-16644 .layout-effect').addClass("favhide").viewportChecker({
...
<div id="favimagehover-16644" class="favth-row">
          ...
          <div id="favimagehover-image-container1">
            ...
            <div id="favimagehover-image1"
                 style="height: 100%;">
                                  ...
                                  <img src="/images/STILLIFE/nuovo/PORTAFINESTRA_BATTENTE2.jpg"
                      alt=""/>
            ...
            <div id="favimagehover-overlay1">
              ...
              style="color: #FFFFFF;
                ...
                Finestre e portefinestre a 1,2,3 o 4 ante a battente.
              </p>
              ...
              <div id="favimagehover-readmore1"
                ...
                <a class="btn" href="javascript: wizPost([{name: 'category', value:'battente'}]);"
                  target="_self"
                  style="color: #FFFFFF;
  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
    jQuery('#favimagehover-18867 .layout-effect').addClass("favhide").viewportChecker({
      classToAdd: 'favshow layout-effect1', // Class to add to the elements when they are visible
      offset: 100
      });
    });
...
<div id="favimagehover-18867" class="favth-row">
          ...
          <div id="favimagehover-image-container2">
            ...
            <div id="favimagehover-image2"
                 style="height: 100%;">
                                  ...
                                  <img src="/images/STILLIFE/nuovo/PORTAFINESTRA_SCORREVOLE2.jpg"
                      alt=""/>
            ...
            <div id="favimagehover-overlay2">
              ...
              style="color: #FFFFFF;
                ...
                Finestre e portefinestre scorrevoli a 1,2,3 o 4 ante.
              </p>
              ...
              <div id="favimagehover-readmore2"
                ...
                <a class="btn" href="javascript: wizPost([{name: 'category', value:'scorrevole'}]);"
                  target="_self"
                  style="color: #FFFFFF;
                        background-color: #C20000;
                        padding: 11px 16px 9px;
