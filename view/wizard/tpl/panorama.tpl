...
<div id="favimagehover-19717" class="favth-row">
  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
    jQuery('#favimagehover-15449 .layout-effect').addClass("favhide").viewportChecker({
      classToAdd: 'favshow layout-effect1', // Class to add to the elements when they are visible
      offset: 100
      });
    });
...
<div id="favimagehover-15449" class="favth-row">
  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
    jQuery('#favimagehover-13459 .layout-effect').addClass("favhide").viewportChecker({
      classToAdd: 'favshow layout-effect1', // Class to add to the elements when they are visible
      offset: 100
      });
    });
...
<div id="favimagehover-13459" class="favth-row">
  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
    jQuery('#favimagehover-17645 .layout-effect').addClass("favhide").viewportChecker({
      classToAdd: 'favshow layout-effect1', // Class to add to the elements when they are visible
      offset: 100
      });
    });
